...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateHermes: "Hades frissítése",
    updatingHermes: "Hades frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "Hades-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `hades plugins` paritás).",
  ...
  env: {
    ...
    customHint: "A .env fájlban tárolt tetszőleges környezeti változók, amelyeket a Hades nem ismer fel. Használd ezeket környezeti változók beillesztésére képességekhez, MCP-kiszolgálókhoz vagy saját eszközeidhez.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető Hades-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "Hades munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a Hadest",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Hades kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A Hades egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
