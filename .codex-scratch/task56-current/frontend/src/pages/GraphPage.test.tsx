...
jest.mock("react-router-dom", () => ({
  ...
  __navigate: require("jest-mock").fn(),
  useNavigate: () => require("react-router-dom").__navigate,
  useParams: () => ({}),
  useSearchParams: () => [new URLSearchParams(), require("jest-mock").fn()],
}), { virtual: true });
...
jest.mock("@/components/devboard/GraphExplorer", () => () => <div>Explorer</div>, { virtual: true });
