...
export const en: Translations = {
  ...
  boot: {
    ready: 'Hades Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Hades settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Hades Desktop…'
    },
    errors: {
      backgroundExited: 'Hades background process exited.',
      backgroundExitedDuringStartup: 'Hades background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Hades backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Hades',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Hades Desktop.',
    ...
    native: {
      ...
      inputBody: 'Hades is waiting for your response.',
      turnDoneTitle: 'Hades finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Hades defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Hades is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Hades asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Hades was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Hades follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Hades is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Hades, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Hades checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Hades configuration...',
    ...
    gateway: {
      ...
      intro:
        'Hades Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Hades backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Hades backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Hades backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Hades Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Hades ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Hades runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Hades to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Hades to generate pets.',
      backgroundHint: 'You can close this — Hades will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Hades desktop' },
    ...
    hermesActiveSessions: (version, count) => `Hades ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@hades:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Hades environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Hades will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'This removes the saved project from Hades. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Hades...',
    placeholderReconnecting: 'Reconnecting to Hades…',
    ...
    attachUrlDesc: 'Hades will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Hades to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Hades…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Hades…',
    ...
    unsupportedMessage: 'This version of Hades can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Hades from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Hades will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Hades desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Hades updater takes over in its own window and reopens Hades automatically when it’s done. Please don’t reopen Hades yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Hades reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Hades reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Hades needs a one-time install',
    ...
    settingUpTitle: 'Setting up Hades Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Hades CLI or desktop instance is running. Stop any running Hades instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Hades installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Hades Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Hades is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Hades…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Hades',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Hades at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Hades connects automatically',
      loopback: 'Opens your browser to sign in — Hades connects automatically',
    ...
    authorizeThere: 'Authorize Hades there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Hades there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Hades inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Hades will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Hades is restarting...',
      askRestart: 'Ask Hades to restart the server',
      lookingRestart: taskId => `Hades is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Hades is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Hades finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Hades could not restart the server.',
      stillWorking:
        'Hades is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Hades is loading a response',
  ...
  prompts: {
    ...
    sudoDesc: 'Hades needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Hades needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Hades Desktop to use Save Image.',
    restartToSaveImages: 'Restart Hades Desktop to save images',
