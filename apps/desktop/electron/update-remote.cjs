 ...
 *
 * A public install can end up with `origin=git@github.com:gabriele/hades-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/gabriele/hades-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/gabriele/hades-agent'
