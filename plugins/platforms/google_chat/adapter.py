...
#     fresh "Hades is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # they don't sit in the chat forever as "Hades is thinking…".
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'Hades is thinking…' marker message.
        ...
        "Hades is thinking…" stuck in chat forever, plus one card that
        ...
        body: Dict[str, Any] = {"text": "Hades is thinking…"}
        if thread_id:
            body["thread"] = {"name": thread_id}
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "Hades is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "Hades is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "Hades is thinking…" card during any subsequent
...
def interactive_setup() -> None:
    ...
    print_info("Restart the gateway: hades gateway restart")
...
async def _standalone_send(
    ...
    *,
    ...
    separate process from ``hades gateway``).  Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # the "Hades is thinking..." marker patches and edit overhead.
        ...
        platform_hint=(
            ...
            "are generating a response, a 'Hades is thinking…' marker message "
