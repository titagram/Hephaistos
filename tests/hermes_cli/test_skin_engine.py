...
class TestSkinConfig:
    ...
    def test_get_branding_with_fallback(self):
        from hermes_cli.skin_engine import load_skin
        skin = load_skin("default")
        assert skin.get_branding("agent_name") == skin.branding["agent_name"]
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        ...
        assert skin.get_color("banner_border") == load_skin("default").get_color(
            "banner_border"
        )
    ...
    def test_load_user_skin_invalid_section_types_fall_back_to_defaults(self, tmp_path, monkeypatch):
        ...
        assert skin.get_color("banner_title") == default_skin.get_color("banner_title")
        assert skin.get_branding("agent_name") == default_skin.get_branding(
            "agent_name"
        )
