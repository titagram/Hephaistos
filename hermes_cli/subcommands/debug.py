...
def build_debug_parser(subparsers, *, cmd_debug: Callable) -> None:
    ...
    debug_parser = subparsers.add_parser(
        ...
        description="Debug utilities for Hades Agent. Use 'hades debug share' to "
        "upload a debug report (system info + recent logs) to a paste "
        "service and get a shareable URL.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""\
Examples:
    hades debug share               Upload debug report and print URL
    hades debug share --lines 500   Include more log lines
    hades debug share --expire 30   Keep paste for 30 days
    hades debug share --local       Print report locally (no upload)
    hades debug share --no-redact   Disable upload-time secret redaction
    hades debug delete <url>        Delete a previously uploaded paste
""",
    )
