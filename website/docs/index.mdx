...
slug: /
sidebar_position: 0
title: "Hades Agent Documentation"
description: "The self-improving AI agent built by Hades Agent. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Hades Agent](https://hades-agent.local). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `hades setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔗 **[Backend Setup](/getting-started/hades-backend)**                  | Link a workspace to shared backend memory, jobs, artifacts, and inbox events   |
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Hades safely  |
| 🧭 **[Use MCP with Hades](/guides/use-mcp-with-hermes)**                | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Hades](/guides/use-voice-mode-with-hermes)**  | Hands-on setup and usage patterns for Hades voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Hades' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Hades                              |
...
- **Provider-flexible** — Works with [Nous Portal](https://portal.hades-agent.local), [OpenRouter](https://openrouter.ai), OpenAI, or any compatible endpoint
...
- **Research-ready** — Batch processing, trajectory export, and RL training workflows
