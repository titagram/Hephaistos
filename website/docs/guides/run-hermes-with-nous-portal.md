...
```
Hey, search the web for "Hades Agent release notes" and summarize the top 3 hits.
```
...
If a model is genuinely unavailable, [open an issue](https://github.com/gabriele/hades-agent/issues) — most gaps are routing config we can update.
