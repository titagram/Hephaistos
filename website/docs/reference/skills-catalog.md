...
| [`hermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) | Configure, extend, or contribute to Hades Agent. | `autonomous-ai-agents/hermes-agent` |
...
| [`requesting-code-review`](/docs/user-guide/skills/bundled/software-development/software-development-requesting-code-review) | Autonomous, evidence-backed engineering review with deterministic verdicts. | `software-development/requesting-code-review` |
