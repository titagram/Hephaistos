...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Hades Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Hades Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Hades core? Start with [Build a Hades Plugin](../guides/build-a-hermes-plugin.md)
- Building a new built-in core tool for Hades itself? Start with [Adding Tools](./adding-tools.md)
...
- **Profile-safe paths**: Never hardcode `~/.hermes` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/gabriele/hades-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [discord.gg/hades-agent](https://discord.gg/hades-agent)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/gabriele/hades-agent/blob/main/LICENSE).
